...
public class CrackJprofile {
        ...
        public static void main(String[] args) throws NotFoundException, CannotCompileException, IOException {
            ...
            // 解压jar包后的路径
//            pool.insertClassPath("/Users/liutongbin/.m2/repository/com/alibaba/fastjson/1.2.16/fastjson-1.2.16");
//            pool.insertClassPath("/Users/liutongbin/.m2/repository/com/alibaba/fastjson/1.2.16");
            pool.insertClassPath("/Applications/JProfiler.app/Contents/Resources/app/bin/jprofiler_old");
//            pool.insertClassPath("\\Applications\\JProfiler.app\\Contents\\Resources\\app\\bin\\jprofiler");

            CtClass cc = pool.getOrNull("com.ejt.framework.e.c");
...
//            CtClass cc = pool.get("com.oracle.javafx.jmx.json.JSONFactory");
            ...
            cc.writeFile("/Applications/JProfiler.app/Contents/Resources/app/bin/jprofiler/jprofiler_modified");
        }
